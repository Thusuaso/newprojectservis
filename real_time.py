...
@socketio.on('get_yapilacaklar_list_event')
...
@socketio.on('get_maliyet_hata_list_event')
def get_maliyet_hata_list_event():
    emit('get_maliyet_hata_list_on',broadcast=True)
