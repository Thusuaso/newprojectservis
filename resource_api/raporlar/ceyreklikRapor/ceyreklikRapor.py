    ...
    def getCeyreklikYear(self):
        try:
            ...
            for item in self.quartersDataOne:
                self.genelToplamBirinciCeyrek += item.genelToplam
            for item in self.quartersDataTwo:
                self.genelToplamİkinciCeyrek += item.genelToplam
            for item in self.quartersDataThree:
                self.genelToplamUcuncuCeyrek += item.genelToplam
            for item in self.quartersDataFour:
                self.genelToplamDorduncuCeyrek += item.genelToplam
