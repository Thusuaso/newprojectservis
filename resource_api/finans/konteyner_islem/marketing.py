        ...
        try:
            ...
            if(len(data['icPiyasa'])>0):
                ...
                for item in data['icPiyasa']:
                    ...
                    sayfa2.cell(satir8,column=13,value=item['musteri'])
                    
                    if(item['toplamFob'] != None):
                        sayfa2.cell(satir8,column=14,value=item['toplamFob'])
                    else:
                        sayfa2.cell(satir8,column=14,value=0)
                    
                    if(item['toplamCfr'] != None):
                        sayfa2.cell(satir8,column=15,value=item['toplamCfr'])
                    else:
                        sayfa2.cell(satir8,column=15,value=0)
                    ...
                    satir8 += 1
                sayfa2.cell(satir8,column=13,value='Toplam').font = Font(color='f44336',bold=True)
                sayfa2.cell(satir8,column=14,value=toplamYuklemeFobIcPiyasa).font = Font(color='f44336',bold=True)
                sayfa2.cell(satir8,column=15,value=toplamYuklemeCfrIcPiyasa).font = Font(color='f44336',bold=True)
